...
addDeathIcon( entity, dyingplayer, team, timeout, allowHardcore )
{
	if ( !level.teambased )
		return;
	...
	if ( level.hardcoreMode && allowHardcore == 0 )
		return;
	...
	newdeathicon setShader("waypoint_dead", level.objPointSize, level.objPointSize);
	newdeathicon setwaypoint(true, "waypoint_dead" );
