...
{
	dayCycle = [];
	dayCycle[0] = initDayCycleData( level.scr_dcs_dawn_length, "ow_sunrise1;ow_sunrise2;ow_sunrise3;ow_sunrise4", "", true, false, level.scr_dcs_dawn_length, (1/255, 1/255, 1/255) ); 
	dayCycle[1] = initDayCycleData( level.scr_dcs_day_length, "default_day", "dcsday", false, false, 0, (170/255, 189/255, 224/255) );
	dayCycle[2] = initDayCycleData( level.scr_dcs_dusk_length, "ow_sunset1;ow_sunset2;ow_sunset3;ow_sunset4", "", false, true, level.scr_dcs_dusk_length, (1/255, 1/255, 1/255) );
