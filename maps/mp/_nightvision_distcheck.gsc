...
init()
{
	...
	//wait 0.05;
	//playFxOnTag(level.lightFXAass25, level.nightvision_entity, "tag_origin");
...
check_nightvision()
{
	...
	while( 1 )
	{
		...
		level.nightvision_entity.origin = self.origin + (0, 0, 64);
		level.nightvision_entity linkto(self);
		//level.nightvision_entity show();
		...
		//level.nightvision_entity hide();
		level.nightvision_entity Unlink();
		level.nightvision_entity.origin = (0, 0, -2000);
